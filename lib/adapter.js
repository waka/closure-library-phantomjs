...
(function() {
  ...
  function replaceTestCase(opt_global) {
    ...
    global.console['log'] = goog.nullFunction;
    global.console['error'] = goog.nullFunction;
  ...
  function replaceAsyncTestCase(opt_global) {
    var global = opt_global || goog.global;
     ...
     * @type {Array.<Object>}
     */
    global.goog.testing.AsyncTestCase.prototype.adapterResults_;

    /**
     * @override
     */
    global.goog.testing.AsyncTestCase.prototype.log = goog.nullFunction;

    /**
     * @override
     */
    global.goog.testing.AsyncTestCase.prototype.runTests = function() {
     ...
     * @override
     */
    global.goog.testing.AsyncTestCase.prototype.doSuccess = function(test) {
      this.result_.successCount++;
     ...
     * @override
     */
    global.goog.testing.AsyncTestCase.prototype.doError = function(test, opt_e) {
      var err = this.logError(test.name, opt_e);
      this.result_.errors.push(err);
